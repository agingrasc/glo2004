...
\begin{itemize}
    ...
    \item \textbf{Diagramme de s\'equence:} Voir ~\ref{fig:ssd_editer_strategie}.
\end{itemize}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=0.7]{fig/ssd_editer_strategie.png}
    \caption{Diagramme des cas d'utilisations}
    \label{fig:ssd_editer_strategie}
\end{figure}
